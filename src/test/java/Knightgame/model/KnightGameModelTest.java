...
class KnightGameModelTest {
    ...
    void getPieceCount(){
        ...
        KnightGameModel model1 = new KnightGameModel(new Piece(PieceType.RED, new Position(0, 0)),
                new Piece(PieceType.BLUE, new Position(1, 1)),new Piece(PieceType.RED,new Position(2,2)));
    ...
    void getPieceType() {
        KnightGameModel model = new KnightGameModel();
        assertEquals(model.getPieceType(0),PieceType.RED);
        assertEquals(model.getPieceType(1),PieceType.BLUE);
    }
    ...
    void isValidMove(){
        ...
        assertEquals(model.isValidMove(0, KnightDirection.STAY ),false);
    ...
    @Test
    void testToString() {
        assertEquals(model.toString(),"[RED(0,0),BLUE(7,7)]");
    }

    @Test
    void testConstructor_invalid() {
        assertThrows(IllegalArgumentException.class, () -> new KnightGameModel(new Piece(PieceType.RED, new Position(0, 0)),
